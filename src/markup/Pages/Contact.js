							...
							<div className="row">
										...
										<ul className="no-margin">
											<li className="icon-bx-wraper left m-b30">
												...
												<div className="icon-content">
													...
													<p>Jai Ganesh Viswas Complex Office No. 231, 2nd Floor, Vishrantwadi, Pune, Maharashtra 411015</p>
												</div>
											</li>
											<li className="icon-bx-wraper left  m-b30">
								...
								<div className="col-lg-6 col-md-6 m-b30">
									<GoogleMaps
										...
										zoom={6}
										center={{ lat: 18.59767671905176, lng: 73.9039295911789 }}
										markers={{ lat: 18.59767671905176, lng: 73.9039295911789 }} //optional
									/>
								</div>
							</div>
						</div>
