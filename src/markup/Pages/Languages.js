													...
													<div className="acod-content">
														...
														<div className="dlab-tabs product-description tabs-site-button m-t30">
															<ul className="nav nav-tabs"> 
																...
																<li><Link data-toggle="tab" to={'/languages'} className="active">Languages</Link></li>
										...
										<div className="col-lg-12">
											<div className="tab-content">
												<form id="login" className="tab-pane active" >
													<h3 className="m-b5">Indian Languages</h3>
													<div className="row sp15">
                                                    <div className="col-lg-6 col-md-6 col-sm-6">
															<div className="form-group">
																<label>Speak *</label>
																<div className="input-group">
																<Multiselect options={objectArray1} displayValue="key"selectionLimit="4"/>
                                                        ...
                                                        <h3 className="m-b5">Foreign Languages</h3>
													<div className="row sp15">
                                                    <div className="col-lg-6 col-md-6 col-sm-6">
															<div className="form-group">
																<label>Speak *</label>
																<div className="input-group">
																<Multiselect options={objectArray} displayValue="key"selectionLimit="2"/>
																	{/* <select className="form-control">
																		<option>Select </option>
																		<option value="yes">Yes </option>
																		<option value="no">No </option>
