...
class PortfolioThemes extends Component {
	render() {
		return (
			<>
				<Header />
													...
													<div className="acod-content">
														...
														<div className="dlab-tabs product-description tabs-site-button m-t30">
															<ul className="nav nav-tabs"> 
																...
																<li><Link data-toggle="tab" to={'/portfoliothemes'} className="active">Portfolio Themes</Link></li>
																<li><Link data-toggle="tab" to={'/clubregistration'} >Club Registration</Link></li>
