					...
					<div className="dlab-bnr-inr overlay-black-middle" style={{backgroundImage:"url(" + img1 + ")"}}>
						<div className="container">
							<div className="dlab-bnr-inr-entry">
								<h1 className="text-white">Maha Ashtami</h1>
								...
								<div className="row">
									...
									<div className="col-lg-6 m-b30">
										...
										<div className="dlab-post-title">
											<h4 className="post-title">Maha Ashtami</h4>
											<p className="m-b10"><h5 class="card-title">13th Oct Maha Ashtami upto 11:49 pm </h5>
													<p>Ashtami Puja - 10:00 am </p>
													<p>Pushpanjali - 11:00 am </p>
													<p>Bhog - 1:00 pm </p>
													<p>Aarati - 8:00 pm </p>
													<p>Sandhi Puja from 11:25 to 12:13 am (Night)</p></p>
